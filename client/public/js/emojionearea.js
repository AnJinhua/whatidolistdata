...
(function (factory, global) {
  ...
  function init(self, source, options) {
    ...
    self.emojiTemplate =
      '<img loading="lazy" alt="{alt}" class="emojione' +
      (self.sprite
        ? '-{uni}" src="' + blankImg + '"/>'
        : 'emoji" src="{img}"/>');
    self.emojiTemplateAlt = self.sprite
      ? '<i class="emojione-{uni}"/>'
      : '<img loading="lazy" class="emojioneemoji" src="{img}"/>';
      ...
      do {
        ...
        items = shortnameTo(
          ...
          self.sprite
            ...
            : '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><img loading="lazy" class="emojioneemoji lazy-emoji" data-src="{img}"/></i>',
          true
        )
          .split("|")
          .join("");
