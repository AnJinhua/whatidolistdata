...
const Media = ({
  ...
  return (
    ...
    >
      ...
      {dropZone && <div className="overlay">Drop file here.</div>}
      <button className="control_btn prev_btn" onClick={goPrev}>
        {"<"}
      </button>
      <button className="control_btn next_btn" onClick={goNext}>
        {">"}
      </button>
      {editable && (
        <div>
...
const defaultSources = [
  {
    src: "https://grace951.github.io/react-image-carousel/img/landing3.jpg",
    type: "img",
  },
  { src: "https://www.youtube.com/embed/GEgSBuYlSoA", type: "youtube" },
  {
    src: "https://grace951.github.io/react-image-carousel/img/landing5.jpg",
    type: "img",
  },
];

const Carousel = React.forwardRef(
  ({ sources: sources_orig, width, height, editable }, ref) => {
      ...
      (image) => {
        ...
        try {
          reader.onloadend = () => {
            ...
            newSources[index] = { type: "img", src: reader.result };
    ...
    const updatePhoto = () => {
      uploadImage(file_img_ref.current.files[0]);
    };
    ...
    const chooseYoutube = () => {
      ...
      youtube_src = youtube_src.replace(
        "https://youtu.be",
