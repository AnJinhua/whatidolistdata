...
function HowItWorks() {
  return (
    <div
      ...
      className="how-it-works-wrapper min-height-full-page"
    >
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="row">
              ...
              <div className="col-md-6">
                <p>
                  Choose from a list of the world's most prestigious experts in
                  any subject.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <p>
                  ...
                  them to start a video education session or schedule one for a
                  later time.
                </p>
              </div>
              <div className="col-md-6">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <p>
                  You can contact our educators and professionals using various
                  features provided in Donnie’s List. Text, Call, or video
                  session to communicate with available professionals instantly.
                </p>
              </div>
            </div>
            <hr />
            <div className="row">
              ...
              <div className="col-md-6">
                <p>
                  Donnie's List wants to make sure every experience is a quality
                  experience. Your reviews are important to us. Let us know how
                  they did by leaving your educator a quick rating after your
                  session.
                </p>
              </div>
              <div className="col-md-6">
